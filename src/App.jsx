          ...
          <div className="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
              ...
              <div className="col mb-5">
                  <div className="card h-100">
                    ...
                    isInCart={this.state.cartItems.some(item => item.id === 1)}/> 
                  </div>
              </div>
              <div className="col mb-5">
                  <div className="card h-100">
                      ...
                      Add  item={{ id: 2 }}
                      addToCart={this.handleAddToCart}
                      isInCart={this.state.cartItems.some(item => item.id === 2)}/>
                  </div>
              </div>
              <div className="col mb-5">
                  <div className="card h-100">
                      ...
                      Add  item={{ id: 3 }}
                      addToCart={this.handleAddToCart}
                      isInCart={this.state.cartItems.some(item => item.id === 3)}/>
                  </div>
              </div>
              <div className="col mb-5">
                  <div className="card h-100">
                      ...
                      Add  item={{ id: 4 }}
                      addToCart={this.handleAddToCart}
                      isInCart={this.state.cartItems.some(item => item.id === 4)}/>
                  </div>
              </div>
              <div className="col mb-5">
                  <div className="card h-100">
                     ...
                     Add  item={{ id: 5 }}
                     addToCart={this.handleAddToCart}
                     isInCart={this.state.cartItems.some(item => item.id === 5)}/>
                  </div>
              </div>
              <div className="col mb-5">
                  <div className="card h-100">
                      ...
                      <Cart  item={{ id: 6 }}
                      addToCart={this.handleAddToCart}
                      isInCart={this.state.cartItems.some(item => item.id === 6)}/>
                  </div>
              </div>
              <div className="col mb-5">
                  <div className="card h-100">
                      ...
                      <Cart  item={{ id: 7 }}
                      addToCart={this.handleAddToCart}
                      isInCart={this.state.cartItems.some(item => item.id === 7)}/>
                  </div>
              </div>
          </div>
      </div>
